...
<div class="row">
	<div class="col-sm-4">
		<form id="frmVentasProductos">
			...
			<select class="form-control input-sm" id="empleadoVenta" name="empleadoVenta">
			...
			<input  id="cantidad" name="cantidad" class="form-control input-sm">
			<label>En Existencia</label>
			<input  id="existencia" name="existencia" class="form-control input-sm" value=""></input>
			<label>Descripcion</label>
			<textarea readonly="" id="descripcion" name="descripcion" class="form-control input-sm"></textarea>
			<label>Precio</label>
